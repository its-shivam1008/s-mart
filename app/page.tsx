      ...
      <main data-scroll onMouseMove={mouseMove} ref={mainRef} className="parent-with-no-height-width-for-locomotivejs">
        ...
        <div className="page4 h-fit w-full overflow-x-hidden flex gap-10 ">
          <div className="relative text-scroll mx-3">
            <h1 className="text-black text-[40vw] min-[0px]:max-md:text-[42vh]">Global</h1>
            <div className="imageCard w-56 h-40 min-[0px]:max-md:w-32 min-[0px]:max-md:h-20 hover:outline-2 hover:outline hover:outline-red-500 outline-offset-2 rounded-[20px] absolute top-48 left-80 rotate-12">
          ...
          <div className="relative text-scroll mx-3">
            <h1 className="text-black text-[40vw] min-[0px]:max-md:text-[42vh] relative">Brands</h1>
            <div className="imageCard w-40 h-56 min-[0px]:max-md:w-20 min-[0px]:max-md:h-32 hover:outline-2 hover:outline hover:outline-[rebeccapurple] outline-offset-2 rounded-[20px] absolute bottom-48 -right-10 -rotate-6">
          ...
          <div className="relative text-scroll mx-3">
            <h1 className="text-black text-[40vw] min-[0px]:max-md:text-[42vh] relative">On</h1>
          </div>
          <div className="relative text-scroll mx-3">
            <h1 className="text-black text-[40vw] min-[0px]:max-md:text-[42vh] relative">Your</h1>
            <div className="imageCard w-56 h-40 min-[0px]:max-md:w-32 min-[0px]:max-md:h-20 hover:outline-2 hover:outline hover:outline-gray-500 outline-offset-2 rounded-[20px] absolute top-48 left-[50%] -rotate-45">
          ...
          <div className="relative text-scroll mx-3">
            <h1 className="text-black text-[40vw] min-[0px]:max-md:text-[42vh] relative">Fingertips!!!</h1>
            <div className="imageCard w-40 h-56 min-[0px]:max-md:w-20 min-[0px]:max-md:h-32 hover:outline-2 hover:outline hover:outline-yellow-200 outline-offset-2 rounded-[20px] absolute top-48 right-[50%] rotate-12">
