    ...
    <div className='grid grid-cols-[1fr,6fr] md:grid-cols-[1fr, 3fr] min-h-screen'>
      ...
      <div className=' md:p-5 pt-5 pl-2  bg-[#f2f2f2] space-y-20'>
       ...
       <div className="space-y-8">
        ...
        <Link href={'/admin/pictures'} className={`${currentPath=='/admin/pictures' ? 'bg-gradient-to-r shadow-2xl from-rose-100 to-teal-100 text-purple-500 rounded-full p-3':'text-[rebeccapurple]'} flex gap-4 items-center font-bold text-xl`}><ImagePlus  className={`${currentPath== '/admin/pictures' ? 'text-purple-500':'text-purple-500'} size-8`} /><div className='hidden md:flex'>Pictures</div></Link>
