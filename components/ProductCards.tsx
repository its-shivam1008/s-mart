...
const ProductCards:FunctionComponent<CardInfo> = ({cardInfo}) => {
    ...
    return (
        <div className="eleProd my-5 w-48 h-fit p-4 m-2 rounded-[12px] flex flex-col gap-2 justify-center shadow-lg outline outline-offset-4 outline-transparent hover:outline-[rebeccapurple] transition-all duration-500 mx-auto hover:scale-105 hover:shadow-2xl hover:shadow-[rebeccapurple]">
