    ...
    <div className='grid grid-cols-[1fr,3fr] min-h-screen'>
      ...
      <div className=' p-5  bg-[#f2f2f2] space-y-20'>
       ...
       <div className="space-y-5">
        ...
        <Link href={'/store/orders'} className={`${currentPath=='/store/orders' ? 'bg-gradient-to-r from-rose-100 to-teal-100 text-purple-500 rounded-full p-3':'text-[rebeccapurple]'} flex gap-4 items-center font-bold text-xl`}><ShoppingBasket className={`${currentPath== '/store/orders' ? 'text-purple-400':'text-purple-300'} size-8`} />Orders</Link>
